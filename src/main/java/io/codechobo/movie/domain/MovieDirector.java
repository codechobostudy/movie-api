...
public class MovieDirector {
    ...
    public MovieDirector(final Movie movie, final Person person, final Integer sort) {
    ...
    public static class MovieDirectorId implements Serializable {
        ...
        public MovieDirectorId(final Long movieNo, final Long personNo) {
        ...
        public boolean equals(Object obj) {
            ...
            MovieDirectorId other = (MovieDirectorId) obj;
            if (movieNo == null) {
